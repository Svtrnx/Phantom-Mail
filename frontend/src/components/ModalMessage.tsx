...
const ModalMessage: React.FC<ModalMessageProps> = ({isOpen, onClose, onOpenChange, html, createdAt, name, address, to}) => {
	...
	return (
		<>
		{isMobile ?
			<Drawer style={{minHeight: '85%'}} placement="bottom" backdrop="blur" isOpen={isOpen} onOpenChange={onOpenChange}>
			<DrawerContent>
			  {(onClose) => (
				<>
